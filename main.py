...
Q = (256 // r) * (256 // m)  # Общее количество прямоугольников для 256x256 изображения
...
class RecirculationNetwork:
    def __init__(self, input_dim, hidden_dim):
        self.Wf = np.random.randn(hidden_dim, input_dim)   # Веса прямого распространения
...
if __name__ == "__main__":
    ...
    input_dim = r * m
    hidden_dim = 8  # Размер скрытого слоя можно настроить
